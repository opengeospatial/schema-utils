...
<xslt:stylesheet version="1.0"
	...
	<xsl:param name="include-crdl">false</xsl:param>
	<xsl:param name="include-xinclude">true</xsl:param>
	<xsl:param name="include-dtll">false</xsl:param>
	<xsl:param name="include-relaxng">false</xsl:param>
	<xsl:param name="include-xlink">false</xsl:param>
