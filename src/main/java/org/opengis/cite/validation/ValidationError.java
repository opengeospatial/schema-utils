...
/**
 * Provides information pertaining to a validation error. Instances of this class are
 * immutable.
 */
public class ValidationError {
	 ...
	 * @param severity The severity level (WARNING, ERROR, CRITICAL).
	 * @param message A brief description of the error.
	 * @param lineNum The line number where the error occurs (-1 if unknown).
	 * @param columnNum The column number where the error occurs (-1 if unknown).
	 * @param pointer A fragment identifier (pointer) that locates the error in the
	 ...
	 * @param severity The severity level (WARNING, ERROR, CRITICAL).
	 * @param message A brief description of the error.
	 * @param diagnostics Supplementary diagnostic information about the error.
	 * @param lineNum The line number where the error occurs (-1 if unknown).
	 * @param columnNum The column number where the error occurs (-1 if unknown).
	 * @param pointer A fragment identifier (pointer) that locates the error in the
	 * invalid representation.
	 */
	public ValidationError(ErrorSeverity severity, String message, String diagnostics, int lineNum, int columnNum,
			String pointer) {
	 ...
	 * @param message A brief description of the error.
	 * @param diagnostics Supplementary diagnostic information about the error.
	 * @param locator Provides information about the location of the error.
	 */
	 ...
	 * @return An integer value greater than zero, or -1 if no value is available;
	 */
	...
	/**
	 * Returns a fragment identifier that identifies the invalid part of some resource
	 * representation. For XML-based representations, such pointers are based on the W3C
	 * XPointer framework.
	...
	/**
	 * <p>
	 * Returns an XML representation of the validation error. The structure is as shown in
	 * the example below:
	 * </p>
	 *
	 * <pre>
	...
	/**
	 * Escapes characters that cause the message to be invalid XML (namely greater than
	 * and less than characters if both are present).
