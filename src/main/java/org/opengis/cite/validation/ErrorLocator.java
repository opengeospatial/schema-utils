...
/**
 * Provides information about the location of a validation error. Instances of this class
 * are immutable.
 */
public class ErrorLocator {
	...
	/**
	 * <p>
	 * Constructor for ErrorLocator.
	 * </p>
	 * @param line a int
	 * @param col a int
	 * @param ptr a {@link java.lang.String} object
	 */
	...
	/**
	 * Returns a pointer specifying the location of the error in some representation. For
	 * XML-based representations, the pointer conforms to the W3C XPointer framework.
	 * @return A String representing a pointer; the format depends on the media type.
	 * @see <a href="http://www.w3.org/TR/xptr-framework/">XPointer Framework</a>
	 */
