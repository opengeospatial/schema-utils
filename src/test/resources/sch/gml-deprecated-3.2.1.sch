...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
  ...
  <sch:title>Deprecated infoset items in GML 3.2 (ISO 19136, Annex I).</sch:title>
  ...
  <sch:pattern id="DeprecatedItems">
    <sch:p>Reports the occurrence of deprecated element and attribute information items.</sch:p>
